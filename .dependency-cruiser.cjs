...
module.exports = {
	forbidden: [
		...
		{
			name: "controller-no-infrastructure",
			comment:
				"Controller modules should not depend on infrastructure modules. Consider using dependency inversion or a shared interface.",
			severity: "error",
			from: { path: "^src/modules/.+/.*\\.controller\\.js$" },
...
// generated: dependency-cruiser@18.0.0 on 2026-07-02T14:49:36.346Z
